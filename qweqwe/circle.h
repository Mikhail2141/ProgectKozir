...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(46, 144);
			...
			this->label1->Text = L"Площадь Круга";
			// 
			// label3
			// 
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label3->Location = System::Drawing::Point(42, 216);
			this->label3->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(141, 20);
			this->label3->TabIndex = 8;
			this->label3->Text = L"Площадь Круга";
			// 
			// label4
			// 
			...
			this->label4->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label4->Location = System::Drawing::Point(42, 260);
			this->label4->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(200, 20);
			this->label4->TabIndex = 9;
			this->label4->Text = L"Периметр Окружности";
			// 
			// button1
			// 
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		{
			MessageBox::Show("Ошибка: Пожалуйста, введите допустимые целочисленные значения радиуса");
			return;
		}
		...
		label3->Text = "Площадь Круга" + " = " + Square.ToString();
		label4->Text = "Периметр Окружности" + " = " + Perimeter.ToString();
	}
};
}
